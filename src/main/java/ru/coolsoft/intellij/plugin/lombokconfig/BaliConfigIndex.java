...
import ru.coolsoft.intellij.plugin.language.psi.LombokConfigPsiUtil;

public class BaliConfigIndex extends FileBasedIndexExtension<ConfigKey, ConfigValue> {
  @NonNls
  public static final ID<ConfigKey, ConfigValue> NAME = ID.create("BaliConfigIndex");
