package ru.coolsoft.intellij.plugin.quickfix;
...
import ru.coolsoft.intellij.plugin.processor.clazz.log.AbstractLogProcessor;
...
public class UseSlf4jAnnotationQuickFix extends AddAnnotationFix implements IntentionAction {
  ...
  public void invoke(@NotNull Project project, @NotNull PsiFile file, @NotNull PsiElement startElement,
    ...
    if (null != psiNamedElement) {
      ...
      final String loggerName = AbstractLogProcessor.getLoggerName(PsiTreeUtil.getParentOfType(psiNamedElement, PsiClass.class));
