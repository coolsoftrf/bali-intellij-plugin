...
import ru.coolsoft.intellij.plugin.processor.handler.singular.AbstractSingularHandler;
...
public class BuilderHandler {
  ...
  String getBuilderClassName(@NotNull PsiClass psiClass, String returnTypeName) {
    ...
    final String builderClassNamePattern = configDiscovery.getStringLombokConfigProperty(ConfigKey.BUILDER_CLASS_NAME, psiClass);
