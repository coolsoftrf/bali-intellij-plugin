package ru.coolsoft.builder.generic.util.collection;
...
public class SingularCollection<T> {
	...
	public static class SingularCollectionBuilder<T> {
		...
		public String toString() {
			return "ru.coolsoft.builder.generic.util.collection.SingularCollection.SingularCollectionBuilder(rawTypes=" + this.rawTypes + ", integers=" + this.integers + ", generics=" + this.generics + ", extendsGenerics=" + this.extendsGenerics + ")";
		}
	}
}
