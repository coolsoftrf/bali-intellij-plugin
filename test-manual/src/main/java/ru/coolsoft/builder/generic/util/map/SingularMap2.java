// Generated by delombok at Fri Jun 10 18:41:16 CEST 2016
package ru.coolsoft.builder.generic.util.map;

import java.util.Map;

public class SingularMap2<A, B> {
  ...
  SingularMap2(final Map rawTypes, final Map<Integer, Float> integers, final Map<A, B> generics, final Map<? extends Number, ? extends String> extendsGenerics) {
  ...
  public static class SingularMapBuilder<A, B> {
    ...
    public SingularMap2<A, B> build() {
      ...
      return new SingularMap2<A, B>(rawTypes, integers, generics, extendsGenerics);
    }
    ...
    public java.lang.String toString() {
      return "SingularMap2.SingularMapBuilder(rawTypes$key=" + this.rawTypes$key + ", rawTypes$value=" + this.rawTypes$value + ", integers$key=" + this.integers$key + ", integers$value=" + this.integers$value + ", generics$key=" + this.generics$key + ", generics$value=" + this.generics$value + ", extendsGenerics$key=" + this.extendsGenerics$key + ", extendsGenerics$value=" + this.extendsGenerics$value + ")";
    }
  }
